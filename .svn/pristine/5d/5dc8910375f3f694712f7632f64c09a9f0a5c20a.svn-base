...
import com.pulan.shiro.CredentialsMatcher;
import com.pulan.shiro.LdapAuthRealm;
@Configuration
public class ShiroConfiguration {
	private Logger logger = Logger.getLogger(ShiroConfiguration.class.getName());
	...
	public ShiroFilterFactoryBean shiroFilter(@Qualifier("securityManager") SecurityManager manager) {
		...
		// 配置登录的url和登录成功的url
		bean.setLoginUrl("/message/login");
		// 配置访问权限 filterChainDefinitionMap必须是LinkedHashMap因为它必须保证有序
		LinkedHashMap<String, String> filterChainDefinitionMap = new LinkedHashMap<String, String>();
//		 filterChainDefinitionMap.put("/message/loginUser", "anon");
		// //表示可以匿名访问
